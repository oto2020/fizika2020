        ...
        <div class="row mt-4">
            <div class="col" v-for="(column, columnIndex) in columns">
                ...
                <div class="input-group mb-3">
                    ...
                    <input v-model="columns[columnIndex].value" @input="convertFromThisColumn(columnIndex)" type="text" class="form-control":class="invalidInputClassName(columnIndex)"  aria-describedby="basic-addon3" >
                ...
                <ul class="list-group">
                    <li v-for="(unit, unitRowIndex) in units" @click="selectUnit(unitRowIndex, columnIndex)" class="list-group-item":class= "activeUnitClassName(unitRowIndex, columnIndex)" >
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            {
                if (this.columns[columnIndex].inputError !== '')
                    return "is-invalid";
                else return ("");
            },
